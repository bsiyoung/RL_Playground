...
cuda_rand_seed : numba cuda random seed

CUDA GPU Configs
----------------------------------------------
n_block : number of blocks
n_th_in_blk : number of threads in a block
'''
...
res = cuda_mab.run_sim(n_block, n_th_in_blk, n_run, n_arm, n_step, 
                       mean, std, agent,
                       stationary, n_step_per_phase, cuda_rand_seed)
en_tm = time.time()
...
plt.savefig('run_example_gpu.png')
plt.show()
